...
$(document).ready(function () {
  $('.burger').click(function () {
    $('.menu_wrapper').fadeIn(150, function () {
      $(this).find('.inner_wrapper').animate(
        {
          marginLeft: 0,
        },
        300
  ...
  $('.menu_wrapper').click(function () {
    let inner_wrapper = $(this).find('.inner_wrapper');
    inner_wrapper.animate(
      {
        marginLeft: -inner_wrapper.outerWidth(),
      },
      300,
      function () {
        $('.menu_wrapper').fadeOut(150);
      }
    );
  });

  $('.menu_wrapper .inner_wrapper').click(function (e) {
    e.stopPropaganation();
  });

  $('#close_menu_wrapper').click(function () {
    let menu_inner_wrapper = $(this).closest('.inner_wrapper');
    menu_inner_wrapper.animate(
      {
        marginLeft: -menu_inner_wrapper.outerWidth(),
      },
      300,
      function () {
        $('.menu_wrapper').fadeOut(150);
...
let product_viewer = $('#product_viewer');

product_viewer.find('path[id]').click(function () {
  let pid = $(this).attr('id');
  product_viewer.find('clipPath').attr('id', pid + 'c');
  product_viewer.find('clipPath').html('<use xlink:href="#' + pid + '"/>');
  product_viewer
    .find('#use_p')
    .attr('xlink:href', '#' + pid)
